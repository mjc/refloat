...
static MotorDataFixture motor_data_fixture_start(void) {
    vesc_if_fake_reset();

    MotorDataFixture fixture = {0};
...
static void motor_data_fixture_configure(MotorDataFixture *fixture, float current_min, float current_max) {
...
static bool test_motor_data_refresh_update_and_alerts(void) {
    MotorDataFixture fixture = motor_data_fixture_start();
