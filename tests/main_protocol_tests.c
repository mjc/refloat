...
int main(void) {
    const TestCase tests[] = {
        ...
        RED_XFAIL_CASE("main info handles optional gnss unavailable", test_main_info_handles_optional_gnss_unavailable,
        ...
        RED_XFAIL_CASE("main realtime handles optional gnss unavailable", test_main_realtime_handles_optional_gnss_unavailable,
        ...
        RED_XFAIL_CASE("main rejects lock and handtest packets without payload", test_main_rejects_short_lock_and_handtest_payloads,
        ...
        RED_XFAIL_CASE("main init main thread spawn failure cleanup", test_main_init_main_thread_spawn_failure_cleans_up,
        ...
        RED_XFAIL_CASE("main init aux thread spawn failure cleanup", test_main_init_aux_thread_spawn_failure_cleans_up,
        ...
        RED_XFAIL_CASE("main init eeprom allocation failure uses defaults", test_main_init_eeprom_allocation_failure_uses_defaults,
        ...
        RED_XFAIL_CASE("main all data saturates oversized float16 fields", test_main_all_data_saturates_oversized_float16_fields,
